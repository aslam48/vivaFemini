...
import { periodIndicatorsOptions, sexualHealthOptions } from "../../../utils/data";
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 w-full">
            {isLoading ? (
              ...
              <>
                ...
                <div className="mb-8">
                  <h3 className="text-lg font-bold text-gray-800 mb-4">Period Indicators</h3>
                  <div className="flex flex-wrap gap-2">
                    {periodIndicatorsOptions.map((indicator) => {
                      const isSelected = selectedPeriod.includes(indicator.label);
                      return (
                        <button
                          key={indicator.label}
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-800 mb-4">Sexual Health</h3>
                  <div className="flex flex-wrap gap-2">
                    {sexualHealthOptions.map((indicator) => {
                      const isSelected = selectedSexual.includes(indicator.label);
                      return (
                        <button
                          key={indicator.label}
